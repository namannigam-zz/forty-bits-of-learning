...
public class LogParser {
    ...
    public static void main(String[] args) {
        ...
        for (String log : logs) {
            ...
            // Get the IP
            String ip = log.substring(log.indexOf(" for "), log.indexOf(" ", log.indexOf(" for "))).trim();
            filters.setIp(ip);
            ...
            if (!log.contains(" as ")) {
                ...
                requestFormat = log.substring(log.indexOf(" as "), log.indexOf(" ", log.indexOf(" as "))).trim();
            }
            filters.setRequestFormat(Filters.RequestFormat.valueOf(requestFormat));

            // Get the status code
            String status =
                    log.substring(log.indexOf(" Completed "), log.indexOf(" ", log.indexOf(" Completed "))).trim();
    ...
    /** Method to count the complete logs to be filtered for a given query and type of query and filter values */
