...
/**
 * Bob is organizing the annual tournament of gold. There are  participants in a line, each starting with  gold. Initially, the entire row of participants is "selected". A round of the tournament proceeds as follows:
 *
 ...
 * He gives  gold to each participant in the subarray.
 ...
 *
 * It can be proven that the expected amount of gold for the  participant can be represented as a fraction   with  and . Print  space-separated integers, the  of which is   modulo
 * It can be proved that  Modulo  exists under the following constraints.
 *
 * Input Format:
 *
 ...
 * Output Format:
 *
 * Print  space separated integers, the  integer denoting the answer for the  participant .
 *
 * Constraints:
 *
 *
