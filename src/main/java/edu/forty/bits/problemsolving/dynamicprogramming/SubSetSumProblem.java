package edu.forty.bits.problemsolving.dynamicprogramming;

import java.util.ArrayList;
import java.util.stream.IntStream;

/*
 * {@see https://www.geeksforgeeks.org/perfect-sum-problem-print-subsets-given-sum/}
 */
public class SubSetSumProblem {
    ...
    private static void printAllSubsets(int arr[], int n, int sum) {
        ...
        IntStream.range(0, n).forEach(i -> dp[i][0] = true);
