...
/**
 * There is a building of 100 floors. If an egg drop from the Nth floor or above, it will break. If it's dropped
 * from any floor below, it will not break. You're given two eggs. Find N, while minimizing the number of drops for
 * the worst case.
 */
