...
/**
 * @link https://www.geeksforgeeks.competitive/given-two-unsorted-arrays-find-pairs-whose-sum-x/
 */
public class PairSumWithTwoArrays {

    // Function to find all pairs in both arrays
    // whose sum is equal to given value x
    private static void findPairs(int[] arr1, int[] arr2, int n, int m, int x) {
