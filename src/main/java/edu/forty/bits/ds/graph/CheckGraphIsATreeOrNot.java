...
public class CheckGraphIsATreeOrNot {
    ...
    public static void main(String args[]) {
        ...
        g1.addEdge(0, 3);
        g1.addEdge(3, 4);
        if (g1.isTree()) System.out.println("Graph is Tree");
        else System.out.println("Graph is not Tree");

        CheckGraphIsATreeOrNot g2 = new CheckGraphIsATreeOrNot(5);
        g2.addEdge(1, 0);
        g2.addEdge(0, 2);
        g2.addEdge(2, 1);
        g2.addEdge(0, 3);
        ...
        if (g2.isTree()) System.out.println("Graph is Tree");
        else System.out.println("Graph is not Tree");
    }
