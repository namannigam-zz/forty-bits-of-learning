...
public class RouteBetweenNodes {
    ...
    // this is more of a BFS on the graph, though even DFS works in this case with O(N) runtime complexity
    // marking nodes as visited would be the primary responsibility while traversing to reduce repeated traversal
