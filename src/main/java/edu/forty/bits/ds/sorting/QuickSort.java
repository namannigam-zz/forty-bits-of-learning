 ...
 *
 * <p>Quick Sort in its general form is an in-place sort (i.e. it doesn't require any extra storage)
 * whereas merge sort requires O(N) extra storage
 *
 * <p>Although the worst case time complexity of QuickSort is O(n2) which is more than many other
