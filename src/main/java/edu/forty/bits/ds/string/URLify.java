...
// replace all spaces in a com.stackoverflow.nullpointer.string with %20, given the sufficient space
// and exact length of the com.stackoverflow.nullpointer.string
...
public class URLify {
  ...
  private static String URLify(char[] str, int exactLength) {
    ...
    // com.stackoverflow.nullpointer.string length
