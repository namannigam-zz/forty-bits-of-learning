...
// find if a com.stackoverflow.nullpointer.string has all unique characters (what if you cannot use
...
public class UniqueString {
  ...
  public static boolean isUnique(String str) {
    ...
    for (int i = 0;
        i < str.length();
        i++) { // O(n) for com.stackoverflow.nullpointer.string length of arguably can be termed as
               // O(1) for maximum of character counts e.g. 128
