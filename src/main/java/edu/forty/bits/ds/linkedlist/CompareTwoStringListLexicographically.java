...
public class CompareTwoStringListLexicographically {
    ...
    public static void compareLinkedList(LinkedList<String> linkedList1, LinkedList<String> linkedList2) {
        if (linkedList1.size() > linkedList2.size()) {
            ...
            while (i < linkedList1.size()) {
                CompareTwoStringListLexicographically
                        .compare(linkedList1.get(i).charAt(0), linkedList2.get(i).charAt(0));
                i++;
            }
        }
    }
    ...
    int compare(LinkedListNode linkedListNode1, LinkedListNode linkedListNode2) {
        ...
        while (linkedListNode1 != null && linkedListNode2 != null && linkedListNode1.data == linkedListNode2.data) {
        ...
        return 0; // covers the case when both the node1 and node2 have ended up with NULL (same strings)
    }
}