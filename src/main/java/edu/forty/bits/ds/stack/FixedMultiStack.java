...
// if the size fo each stack is defined we can create an array according to it and distribute elements
public class FixedMultiStack {
    ...
    // in our example the number of stacks is fixed to 3, but it could also be varied for fixed size multi stacks
