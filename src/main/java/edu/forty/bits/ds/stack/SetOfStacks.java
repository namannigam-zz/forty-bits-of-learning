...
public class SetOfStacks {
    ...
    // pop would also work on the last stack of plates with a check for empty list of stacks and a corner case for stack getting empty
    int pop() {
        Stack last = getLastStack();
        if (last == null) {
    ...
    // stack implementation to keep the track of plates above and below one plate and perform operations accordingly
    class Stack {
        private int capacity;
        Node top, bottom;
        public int size = 0;
