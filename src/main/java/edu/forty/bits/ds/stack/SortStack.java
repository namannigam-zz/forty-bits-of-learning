...
// sort stack to keep the smallest element at the top,
// can use additional temporary stack but may not copy elements into any other data structure,
// operations to be supported - push, pop, peek, isEmpty
public class SortStack {

    // one way to implement this could have been using two stacks and keeping a minimum value same as the Min operations
