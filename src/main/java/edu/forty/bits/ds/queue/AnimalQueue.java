...
// create a data structure for this system and provide operations like enqueue , dequeueAny, dequeueDog, dequeueCat
...
public class AnimalQueue {
    ...
    // one could follow two approaches here, either use two separate queues for each type and then perform operations
    // or implement single queue and then perform operations (tough would be dequeue<specific> in this case)
